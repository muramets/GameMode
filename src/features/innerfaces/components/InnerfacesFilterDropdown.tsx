...
/**
 * Компонент dropdown меню для фильтрации innerfaces по группам
 */
export function InnerfacesFilterDropdown({
    activeFilters,
    innerfaceGroups,
    groupsMetadata,
    hasUngrouped,
    onToggleFilter,
}: InnerfacesFilterDropdownProps) {
        ...
        <div className="relative group">
            ...
            <div className="absolute top-full right-0 mt-2 w-48 bg-sub-alt rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 p-2 transform origin-top-right border border-white/5">
                <div className="flex flex-col">
                    {/* Опция "All powers" - сбрасывает все фильтры */}
                    <button
                    ...
                    {/* Разделитель */}
                    {(innerfaceGroups.length > 0 || hasUngrouped) && (
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-4 flex items-center justify-center">
                                    <FontAwesomeIcon icon={icon} style={{ color }} className="text-[10px]" />
                                </div>
                                <span
                    ...
                    {/* Опция "Ungrouped" - innerfaces без группы */}
                    {hasUngrouped && (
                        <button
